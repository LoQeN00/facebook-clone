...
export const SinglePost = React.forwardRef<HTMLDivElement, Props>(({ post, setPostsData, loadedPosts }: Props, ref) => {
  ...
  const [deletePost] = useMutation(DELETE_POST_MUTATION, {
    async onCompleted() {
      ...
      loadedPosts.current = loadedPosts.current.filter((postData) => post.id !== postData.id);
